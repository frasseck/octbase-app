...
### ### ### ### ###
Octbase currently only knows releases. Additionally I want to be able to include sprints. Review the application and add a sprint functionality. Look into this: https://medium.com/@confeurhq/sprints-vs-releases-6fe700d101f9 I want to have both features in Octbase. Releases that sum up features for releases and sprints that are used to get there step by step.