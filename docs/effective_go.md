...
License: Copyright © Google LLC, licensed under https://creativecommons.org/licenses/by/3.0/
This is a local mirror kept as a coding best-practices reference for Octbase.
Canonical, up-to-date version lives at the Source URL above.
-->
...
or libraries added since. See [issue 28782](https://go.dev/issue/28782) for context.
