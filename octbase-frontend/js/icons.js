...
const ICONS = {
  ...
  milestone:      '<path d="M6 22V2.8a.8.8 0 0 1 1.17-.71l11.38 5.69a.8.8 0 0 1 0 1.44L6 15.5"/>',
  ...
  stats:          '<path d="M3 3v16a2 2 0 0 0 2 2h16"/><path d="M7 16v-5"/><path d="M12 16V7"/><path d="M17 16v-8"/>',
  ...
  mindmap:        '<path d="M12 18V5"/><path d="M15 13a4.17 4.17 0 0 1-3-4 4.17 4.17 0 0 1-3 4"/><path d="M17.598 6.5A3 3 0 1 0 12 5a3 3 0 1 0-5.598 1.5"/><path d="M17.997 5.125a4 4 0 0 1 2.526 5.77"/><path d="M18 18a4 4 0 0 0 2-7.464"/><path d="M19.967 17.483A4 4 0 1 1 12 18a4 4 0 1 1-7.967-.517"/><path d="M6 18a4 4 0 0 1-2-7.464"/><path d="M6.003 5.125a4 4 0 0 0-2.526 5.77"/>',
...
// Two canonical icon sizes: 'md' (20px) for controls/buttons/nav, 'sm' (16px)
// for glyphs sitting inline with text. 'hero' (48px) is reserved for
// empty-state illustrations only. Anything else (including a stray numeric px)
// is snapped to one of these, so the icon set can never drift back to a dozen
// ad-hoc sizes.
...
// icon renders a registry glyph as an inline SVG. Pass size 'sm' | 'md' | 'hero'
// and optional extra classes; the SVG is aria-hidden — label the surrounding
// control instead.
...
// iconBtn lived here until 37b stage 6 and had no caller left in this SPA — a
// leftover of the split from the former single app.js. The mobile app has its
// own (js/core.js), which is the one still in use.

// ═══════════════════════════════════════════════════════════
// AUTH MODULE — token stored in memory only (never localStorage)
// ═══════════════════════════════════════════════════════════
