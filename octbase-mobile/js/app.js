  ...
  el('#app-root').innerHTML = html`
    <div class="login">
      ...
      <nav class="auth-legal">
        <a href="https://octbase.io/privacy.html" target="_blank" rel="noopener">${raw(t('auth.privacy'))}</a>
        <span aria-hidden="true">·</span>
        <a href="https://octbase.io/impressum.html" target="_blank" rel="noopener">${raw(t('auth.imprint'))}</a>
      </nav>
    </div>`;
}
